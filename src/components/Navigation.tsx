  ...
  return (
    <nav className="relative flex items-center gap-[57px] my-[17px] md:my-[28px] px-[22.6px] md:px-[39.6px] w-full max-w-[1190px] mx-auto">
      ...
      <div className="flex md:flex flex-col md:flex-row justify-between items-center w-full">
        ...
        <div className="flex md:flex-row justify-end items-center gap-[22px] md:gap-[46px] text-[20px] md:text-[16px] w-full md:w-auto md:pt-0 border-t border-grayish-violet md:border-none">
          <button>
